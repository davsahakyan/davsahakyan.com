    ...
    <section id="projects">
        <ProjectSingle :image-url='g2l' image-alt='Global to Local Website' button-color="255, 46, 64" website-url="https://global-to-local.se">
            ...
            <template v-slot:description>
                Fully redesigned a website for an Sweden-based organization “Global to Local”
            </template>
        ...
        <ProjectSingle :image-url='edujustice' image-alt='Edujusticeforum Website' button-color="25, 115, 251" website-url="https://edujusticeforum.am">
            <template v-slot:name>
                Edujusticeforum
            </template>
            <template v-slot:date>
            ...
            <template v-slot:description>
                Built a website for an educational justice forum held regularly in Yerevan, Armenia
            </template>
            <template v-slot:actionText>
                Visit
            </template>
        ...
        <ProjectSingle :image-url='ma_ma' image-alt='Ma-Ma Banner Board' button-color="46, 134, 86" website-url="https://ma-ma.dk/">
            ...
            <template v-slot:description>
                Created 40+ animated advertisement banners for a Danish company
            </template>
            <template v-slot:actionText>
                Visit
            </template>
